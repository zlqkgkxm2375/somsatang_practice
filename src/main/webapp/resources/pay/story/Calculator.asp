...
<head>
<meta charset="utf-8">
<title>급여계산기 - 알바천국</title>

<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=no" />

<meta name="format-detection" content="telephone=no" />
<meta name="msapplication-TitleImage" content="//image.alba.kr/m/homeIcon_192.png" />
<meta name="apple-mobile-web-app-title" content="알바천국 모바일" />
<meta name="application-name" content="알바천국 모바일" />
...
<link rel="apple-touch-icon-precomposed" href="//image.alba.kr/m/homeIcon_192.png" />
<link rel="icon" sizes="192x192" href="//image.alba.kr/m/homeIcon_192.png" />
<link rel="icon" sizes="32x32" href="/favicon.ico" />

		<link rel="stylesheet" href="/css/20210923/Sub.css" />
		<link rel="stylesheet" href="/css/20210923/Story.css" />
		<link rel="stylesheet" href="/css/20210923/Repute.css" />
	
	<link rel="preload" as="script" href="/rsc/js/jquery-1.8.3.min.js" />
	<script src="/rsc/js/jquery-1.8.3.min.js"></script>
...
<script src="/rsc/js/CommonCtrl.js?202109171300"></script>
<script src="/js/20210916/LocalStorageController.js?202109171300"></script>
<script src="/rsc/js/CommonUI.js?202109171300"></script>

<script src="/rsc/js/swiper.min.js"></script>
...
<script src="/rsc/js/KeyUpFix.js"></script>
...
<script src="/rsc/js/Header.js?202109171300"></script>
...
<section id="Section">
	...
	<form name="calForm" method="post">
		...
		<div class="calculator__setting">
			...
			<div id="PCal_cont" class="calculator__setup">
				<ul class="calculator__setup-list">
					...
					<li class="probation"><span class="item">수습 <a href="#ModalMemoProbation" class="icon-help" onclick="$('#ModalMemoProbation').appendTo($(this).parent()).addClass('on');return false;">?</a></span>
		...
		<ul class="calculator__info">
			<li class="calculator__info-item">근무시간은 <em>사업주와 별도로 협의</em>된 사항이 없다면 <em>휴게시간을 제외하고 계산</em>해주세요.</li>
		...
		<div class="layer__wrap">
			...
			<div class="layer__contents">
				<div class="layer__definition-wrap">
					...
					<p class="layer__postscript">주휴수당에 대해 좀 더 자세한 문의는 알바상담센터에서 확인하세요 <a href="/story/LaborConsultList.asp" class="layer-postscript-link" onclick="_lsCtrl.goInOutLink({'menunm':'권익센터',url:this.href,action:'NEW_WINDOW_TITLE'});return false;">알바상담센터 바로가기</a></p>
				</div>
			</div>
			<button type="button" class="layer__close-button" onclick="formLayerClose();">레이어 닫기</button>
		</div>
	...
	<div id="ModalMemoProbation" class="modal-memo">
		<h1 class="modal-memo__h1">수습적용</h1>
		<ul class="modal-memo__list">
			<li>예상 급여액의 10% 차감</li>
		</ul>
		<a href="#ModalMemoProbation" class="modal-memo__close" onclick="$('#ModalMemoProbation').removeClass('on');return false;">닫기</a>
	</div>
...
(function($) {
	$(window).load(function() {
		loadJS("/rsc/js/FooterCLS.js?202109171300", function() {});
	});
})(jQuery);
</script>

<article id="PR_Bottom" class="adBannerBottom">
	<a href='https://map.kakao.com/info/kakao_map' style='display:block;background-color:#3b98fc' onclick="_lsCtrl.goInOutLink({url:this.href,action:'EXTERNAL_BROWSER'});return false;"><img src='//image.alba.kr/adbanner/m_home/footer_kakao.png' alt='카카오맵 당신을 좋은 곳으로 이끌어줄지도' /></a>
</article>
...
(function($) {
	$(function() {
		...
		loadJS("/rsc/js/GoogleAnalyticsEventHandler.js?202109171300", function() {});
	});
})(jQuery);
