		...
		<header id="header" class="font-gmarket">
			...
			<div id="headerInnerWrap">
				...
				<div id="headerInner" class="clearfix">
					...
					<h1 class="logo"><a href="#" title="메인으로"><img src="resources/images/face_ic.svg" alt="" width="30" height="24" class="d-inline-block align-text-top"></a></h1>
        ...
        <div class="col-md-6 contents">
          <div class="row justify-content-center">
            <div class="col-md-8">
              ...
              <p class="mb-4">직원 로그인 페이지</p>
            </div>
            <form action="elogin" method="post" modelAttribute="emp">
              ...
              <div class="d-flex mb-5 align-items-center">
                ...
                <span class="ml-auto"><a href="/pany/efindId" class="forgot-pass">Forgot ID/ </a>
                <a href="/pany/efindPass" class="forgot-pass"> Password/ </a>
                <a href="/pany/ejoin" class="forgot-pass"> SIGN</a></span> 
