...
<br><br><br><br>
  <div class="content">
    <div class="container">
      <div class="row">
          <div class="container">
<form:form modelAttribute="gitime" Name='EmainForm' id='EmainForm' method='post'>
	${message}<br>
    <!-- button -->
 ...
 <form:form modelAttribute="home" Name='EhomeForm' Method='post'>
<input type="hidden" name="numh" value="${home.numh}" />
        <!-- 일정 추가 MODAL -->
