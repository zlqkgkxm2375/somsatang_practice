...
<%=session.getAttribute("eid")%> 
 ...
 <script>
 function gobtn() {
	 	document.EmainForm.gu.value ="출근";
		document.EmainForm.action = "goUpdate";
		document.EmainForm.submit();
	}
 
 function outbtn() {
		document.EmainForm.gu.value ="퇴근";
		document.EmainForm.action = "goUpdate";
		document.EmainForm.submit();
	}
 
 function homebtn() {
		document.EmainForm.action = "ehomeUpdate";
		document.EmainForm.submit();
	}

 function vacationbtn() {
		document.EmainForm.action = "evacationUpdate";
		document.EmainForm.submit();
	}
			...
			<div id="headerInnerWrap">
				...
				<nav id="gnb" class="each-menu">
					...
					<ul class="clearfix menu6 area">
						<li class="gnb1">
							<a href="/pany/eedit?empId=${eid}">회원수정</a>
						</li>
						<li class="gnb2">
...
<br><br><br><br>
  <div class="content">
    <div class="container">
      <div class="row">
          <div class="container">
<form:form modelAttribute="gtime" Name='EmainForm' id='EmainForm' method='post' Action='/pany/Gtime' onsubmit='return Check_Pre()'>
	${message}<br>
    <!-- button -->
    <a href="#" onclick="gobtn()" class="btn btn-primary btn-sm mx-2" id="ego" name="ego">출근</a>
    <a href="#" onclick="outbtn()" class="btn btn-secondary btn-sm mx-2" id="eout" name="eout">퇴근</a>
    <a href="#" onclick="homebtn()" class="btn btn-primary btn-sm mx-2" id="ehome" name="ehome">재택</a>
    <a href="#" onclick="vacationbtn()" class="btn btn-secondary btn-lg mx-2" id="evac" name="evac">연차</a>
