...
<SCRIPT>  
    function Cancel_btn() 
    {
       EfindPassForm.eid.value="";
       EfindPassForm.epwd.value="";
       EfindPassForm.eid.focus();
    }
    
    function Check_Pre() 
    {
        if (EfindPassForm.eid.value.length < 1 ){ 
            alert ("아이디를 입력하세요.");
            EfindPassForm.eid.value="";
            EfindPassForm.eid.focus(); 
            return false;
        }
        if (EfindPassForm.eemail.value.length < 1){ 
            alert ("email 주소를 정확히 입력하세요.");
            EfindPassForm.eemail.value="";
            EfindPassForm.eemail.focus();
            return false;
        }
        return true;
    }
        ...
        <div class="col-md-6 contents">
          <div class="row justify-content-center">
            <div class="col-md-8">
              ...
              <p class="mb-4">직원 비밀번호 찾기</p>
            </div>           
            <form action="/pany/efindPass" name="EfindPassForm" method="post" modelAttribute="emp" onsubmit='return Check_Pre()'>
              ...
              <div class="form-group last mb-4">
                ...
                <span class="fieldError"><form:errors path="eemail" /></span>
