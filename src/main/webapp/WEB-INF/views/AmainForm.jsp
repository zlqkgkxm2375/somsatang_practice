...
function fnCmdSave() {	
	document.AcalenForm.action = 'addSave';
	 
	if (document.AcalenForm.dno.value == ""){
		document.AcalenForm.dno.value = 0;
	}
	
	document.AcalenForm.submit();
}
</script>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <input class="inputModal" type="text" name="title" id="title" value="asd"
                                    required="required" />
                            </div>
                        </div>
                        <div class="row">
