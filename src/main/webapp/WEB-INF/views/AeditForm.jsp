...
function Check_Pre() 
{
   if (AeditForm.epwd.value != AditForm.epwd2.value){
		alert("패스워드가 일치하지않습니다.");
      AeditForm.epwd.value="";
	   AeditForm.epwd2.value="";
	   AeditForm.epwd.focus();
	    return false;
   }
   
   var loc = '/pany/Acheckid?empId='+EjoinForm.eid.value
   location.href = loc ;
}
...
function Check_Pre() 
{
	...
	if (AeditForm.apwd.value != AeditForm.apwd2.value){ 
	    alert ("패스워드가 일치하지않습니다.");
       AeditForm.apwd.value="";
	    AeditForm.apwd2.value="";
	    AeditForm.apwd.focus();
	    return false;
	}
	return true;
}
          ...
          <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">회원수정</h2>
                        <form:form modelAttribute="admin" Name='AeditForm' Method='post' action="/pany/aedit" onsubmit='return Check_Pre()' class="register-form">
                            <div class="form-group">
                              <form:input class="form-control" path="aid" readonly='true' />
                        <span class="fieldError"><form:errors path="aid" /></span>
                            ...
                            <div class="form-group">
                              <form:input path="aname" class="form-control" placeholder="User Name"  readonly='true'/>
                              <span class="fieldError"><form:errors path="aname" /></span>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="aemail" id="aemail" placeholder="User Email"/>
                            </div>
                            <div class="form-group form-button">
                                <input type='submit' value='수정' class="form-submit">
                                <input type='button' value='탈퇴' OnClick = 'Delete()' class="form-submit">
                            </div>
