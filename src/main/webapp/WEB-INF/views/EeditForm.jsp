...
function Check_Pre() 
{
   if (EeditForm.epwd.value != EditForm.epwd2.value){
		alert("패스워드가 일치하지않습니다.");
      EeditForm.epwd.value="";
	   EeditForm.epwd2.value="";
	   EeditForm.epwd.focus();
	    return false;
   }
...
function Check_Pre() 
{
	...
	if (EeditForm.epwd.value != EeditForm.epwd2.value){ 
	    alert ("패스워드가 일치하지않습니다.");
	    EeditForm.epwd.value="";
	    EeditForm.epwd2.value="";
	    EeditForm.epwd.focus();
          ...
          <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form:form modelAttribute="emp" Name='EeditForm' Method='post' action="/pany/eedit" onsubmit='return Check_Pre()' class="register-form">
                            <div class="form-group">
                              <form:input class="form-control" path="eid" readonly='true' />
                        <span class="fieldError"><form:errors path="eid" /></span>
                            ...
                            <div class="form-group">
                              <form:input path="ename" class="form-control" placeholder="User Name"  readonly='true'/>
                              <span class="fieldError"><form:errors path="ename" /></span>
                            </div>
                            <div class="form-group">
