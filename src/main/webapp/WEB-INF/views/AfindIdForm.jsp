        ...
        <div class="col-md-6 contents">
          <div class="row justify-content-center">
            <div class="col-md-8">
              <div class="mb-4">
              <h3>Admin Login</h3>
              <p class="mb-4">관리자 아이디 찾기</p>
            </div>
            
            
            <form action="/pany/afindId" name="AfindForm" method="post" modelAttribute="admin" onsubmit='return Check_Pre()'>
              <div class="form-group first">
                <label for="username">User Name</label>
                <input type="text" class="form-control" name="aname" id="amame"/>
              ...
              <div class="form-group last mb-4">
                ...
                <span class="fieldError"><form:errors path="aemail" /></span>
