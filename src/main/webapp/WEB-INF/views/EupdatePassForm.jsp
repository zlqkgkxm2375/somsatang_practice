...
<SCRIPT> 
    ...
    function Check_Pass() 
    {
        if (EupdatePassForm.epwd.value.length < 1 ){ 
            alert ("패스워드를 입력하세요.");
            EupdatePassForm.epwd.focus(); 
            return false;
        }
        if (EupdatePassForm.epwd2.value.length < 1){ 
            alert ("패스워드 확인을 입력하세요.");
            EupdatePassForm.epwd.focus();
            return false;
        }
		if (EupdatePassForm.epwd.value != EupdatePassForm.epwd2.value) { 
            alert ("패스워드가 일치하지 않습니다.");
            EupdatePassForm.epwd.value="";
			EupdatePassForm.epwd2.value="";
            EupdatePassForm.epwd2.focus();
            return false;
        }
        return true;
    }
      ...
      <div class="row">
        ...
        <div class="col-md-6 contents">
          <div class="row justify-content-center">
            ...
            <form:form action="/pany/eupdatePass" name="EupdatePassForm" method="post" modelAttribute="emp" onsubmit='return Check_Pre()'>
              <div class="form-group first">
                <label for="username">User ID</label>
                <form:input type="text" class="form-control" name="eid" id="eid" value="${empId}" path="eid"/>
                <span class="fieldError"><form:errors path="eid" /></span>

              </div>
              <div class="form-group last mb-4">
                <label for="epwd">새비밀번호</label>
                <input type="password" class="form-control" name="epwd" id="epwd"  /> 
                <span class="fieldError"><form:errors path="epwd" /></span>
                
              </div>

			  <div class="form-group last mb-4">
                <label for="epwd2">새비밀번호확인</label>
                <input type="password" class="form-control" name="epwd2" id="epwd2" value="" showPassword="true"/> 
                <span class="fieldError"><form:errors path="epwd" /></span>
