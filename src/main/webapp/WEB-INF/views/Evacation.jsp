...
<br><br><br><br>
  <div class="content">
    <div class="container">
      <div class="row">
          <div class="container">
<form:form modelAttribute="gtime" Name='EmainForm' id='EmainForm' method='post' >
	${message}<br>
    <!-- button -->

	<a href="/pany/evacationView?eid=${eid}" class="btn btn-secondary btn-sm mx-2" id="add">자세히</a>
 ...
 <form:form modelAttribute="vacation" Name='AvacationForm' Method='post'>
<input type="hidden" name="numv" value="${vacation.numv}" />
        <!-- 일정 추가 MODAL -->
