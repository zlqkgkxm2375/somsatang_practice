        ...
        <div class="col-md-6 contents">
          <div class="row justify-content-center">
            <div class="col-md-8">
              ...
              <p class="mb-4">직원 아이디 찾기</p>
            </div>           
            <form action="/pany/efindId" name="EfindIdForm" method="post" modelAttribute="emp" onsubmit='return Check_Pre()'>
              <div class="form-group first">
                <label for="username">User Name</label>
                <input type="text" class="form-control" name="ename" id="emame"/>
