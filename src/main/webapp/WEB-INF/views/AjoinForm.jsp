...
function Check_id() 
{
   if (AjoinForm.aid.value.length < 1){
		alert("아이디를 입력하세요.");
		AjoinForm.aid.focus();
		return false;
   }
   
   var loc = '/pany/acheckid?adminId='+AjoinForm.aid.value
   location.href = loc ;
}
...
function Check_Pre() 
{
	...
	if (AjoinForm.available_aid.value != "1"){ 
	    alert ("중복확인을 클릭하여 주세요.");
	    AjoinForm.aid.value="";
	    AjoinForm.aid.focus();
	    return false;
	}
	if (AjoinForm.apwd.value != AjoinForm.apwd2.value){ 
	    alert ("패스워드가 일치하지않습니다.");
	    AjoinForm.apwd.value="";
	    AjoinForm.apwd2.value="";
	    AjoinForm.apwd.focus();
	    return false;
	}
          ...
          <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form:form modelAttribute="admin" Name='AjoinForm' Method='post' action="/pany/ajoin" onsubmit='return Check_Pre()' class="register-form">
                            <div class="form-group">
                                <label for="aid"><i class="zmdi zmdi-account material-icons-name"></i></label><br>
                                <input type="text" name="aid" id="eid" value="${adminId}" placeholder="User ID"/>
                           <input type='button' class="btn btn-black" OnClick='Check_id()' value='ID 중복검사'>
                            <span class="fieldError"><form:errors path="aid" /></span><span class="fieldError"> ${message}</span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="apwd2" id="apwd2" placeholder="Repeat user password"/>
                            </div>
                            <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="aname" id="aname" placeholder="User Name"/>
                            </div>
                            <div class="form-group">
                                <label for="aphone"><i class="zmdi zmdi-email"></i></label>
                                <input type="text" name="aphone" id="aphone" placeholder="User Phone"/>
                            </div>
                            <div class="form-group">
                                <label for="email"><i class="zmdi zmdi-email"></i></label>
                                <input type="aemail" name="aemail" id="aemail" placeholder="User Email"/>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="signup-image">
                        <figure><img src="resources/join_main/images/signup-image.jpg" alt="sing up image"></figure>
                        <a href="/pany/alogin" class="signup-image-link">I am already member</a>
                    </div>
                </div>
            </div>
