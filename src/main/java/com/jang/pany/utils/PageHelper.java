...
if(currentBlock > 1){
	pageHtml.append("<span><a href=\"AgoList?page=" + (currentPage-1) + "\"><이전></a>&nbsp;&nbsp;");
}else{
...
pageHtml.append(".&nbsp;<a href=\"AgoList?page=" +i + "\" class=\"page\">" + i + "</a>&nbsp;");
}
}
//현재 블록 안이 전체 블럭 보다 작으면 [다음] 표시
if(currentBlock < totalBlock){
	pageHtml.append(".&nbsp;&nbsp;<a href=\"AgoList?page=" + (currentPage+1) + "\"><다음></a></span>");
}else{
	pageHtml.append(".</span>");
}
